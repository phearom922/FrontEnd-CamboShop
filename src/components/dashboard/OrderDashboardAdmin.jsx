    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4 mb-8">
                {/* Card 1: Total Orders */}
                <div className="rounded-lg bg-green-100 py-10 px-6 shadow">
                ...
                <div className="rounded-lg bg-red-100 py-10 px-6 shadow">
                    <div className="flex items-center justify-between">
                        <div>
                ...
                <div className="rounded-lg bg-blue-200 py-10 px-6 shadow">
                    <div className="flex items-center justify-between">
                        <div>
                ...
                <div className="rounded-lg bg-blue-800 py-10 px-6 shadow">
                    <div className="flex items-center justify-between">
                        <div>
                                        ...
                                        <div className="flex items-center">
                                            <div >
                                                <div className="text-sm font-medium text-gray-900">
                                                   ({order.shippingAddress.fullName}) {order._id.slice(-12)} {/* แสดงเฉพาะส่วนท้ายของ ID */}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
